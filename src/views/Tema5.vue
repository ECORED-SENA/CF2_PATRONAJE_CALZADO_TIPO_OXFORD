...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.mb-5
      ...
      .col-xl-auto
        figure(data-aos="fade-left").d-none.d-xl-block
          img(src="@/assets/curso/temas/img53.svg", alt="" style="max-width: 295px").m-auto
    ...
    figure.estilo___caja_3.ajuste___color_2.mb-5(data-aos="zoom-in")
      img(src="@/assets/curso/temas/img54.png", alt="Marcación del centro en la punta y el talón de la horma usando una regla como guía." style="max-width: 650px").m-auto
    
    .row.align-items-center.mb-5.ajustes___movil-1
      .col-xl
        .row.estilo___caja_23.mb-4.m-0(data-aos="fade-right")
          .col-xl-auto
            figure.d-none.d-xl-block
              img(src="@/assets/curso/temas/img55.svg", alt="" style="max-width: 90px").m-auto
          .col-xl
            p.mb-0 Existen diversas formas de obtener la copia de la horma; una de las más precisas y ampliamente utilizadas consiste en enmascararla o forrarla con papel o cinta para llevarla a un sistema plano. El enmascarado es el primer paso del proceso de patronaje. Consiste en cubrir de forma uniforme la superficie de la horma con cinta adhesiva para trazar sobre ella el diseño del zapato. Luego, esta capa se retira fácilmente y se transfiere al papel, lo que permite convertir el diseño tridimensional en uno plano de manera ágil y precisa.
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta acordeonA")(data-aos="zoom-in")
      .row(titulo="Aplicación de la primera tira de cinta en la horma").ajuste-cajaAcordion
        p.mb-4 Para comenzar este procedimiento, se utiliza cinta de enmascarar. El primer paso consiste en colocar una tira de cinta en el centro del empeine y otra en el centro del talón, tal como se indica en la siguiente figura.
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img57.jpg", alt="Colocación de una tira de cinta de enmascarar desde el centro del talón hasta la punta del empeine para iniciar el proceso de enmascarado. ").m-auto
      ...
      .row(titulo="Refuerzo del enmascarado en el empeine y lateral").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img58.jpg", alt="Aplicación de cintas adicionales en el empeine y el lateral de la horma para reforzar el enmascarado y cubrir uniformemente la superficie. ").m-auto
      .row(titulo="Cobertura lateral completa de la horma").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img59.jpg", alt="Enmascarado completo de ambos laterales de la horma con tiras de cinta superpuestas que aseguran una cobertura uniforme para el patronaje.").m-auto
      .row(titulo="Aplicación de cinta sobre la horma en el eje del empeine").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img60.jpg", alt="Aplicación de cintas superpuestas en el empeine de la horma, cubriendo de la punta hacia arriba.").m-auto
      .row(titulo="Marcación de bordes en la horma").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img61.jpg", alt="Conjunto de vistas de una horma en las que se aprecia la cinta aplicada y la marcación de los bordes con lápiz antes del recorte.").m-auto
      .row(titulo="Cinta de enmascarar para refuerzo").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img62.jpg", alt="Tira de cinta de enmascarar recortada y alineada sobre una superficie de corte, lista para ser aplicada sobre la horma. ").m-auto
      .row(titulo="Horma completamente enmascarada").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img63.jpg", alt="Vista superior de la horma con cobertura total de cinta de enmascarar, lista para el trazado del diseño del calzado. ").m-auto
      .row(titulo="Horma enmascarada con línea central marcada").ajuste-cajaAcordion
        ...
        .row.justify-content-center
          .col-xl-8
            ...
            figure
              img.mb-2(src="@/assets/curso/temas/img64.jpg", alt="Horma completamente cubierta con cinta de enmascarar y línea central trazada sobre la superficie para guiar el diseño del patrón. ").m-auto
